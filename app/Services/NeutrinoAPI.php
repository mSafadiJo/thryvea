...
class NeutrinoAPI {
    ...
    private $apiUser = 'allieddigitalmedia';

    // set your actual api-key here
    private $apiKey = '0ZCHkvN6q8qnfiItIbu1KEjs0Y6yi1aobYNgKGJ3byLiM3PA';
...
//======================================================================================================================
     ...
     * @return array
     */
    public function phoneValidate($phoneNumber, $countryCode = 'US')
    {
        $data = array();
