            ...
            if (in_array(3, $compaign_crm_arr)) {
                ...
                switch ($user_id) {
                    case 11:
                        ...
                        $campaign_id_data = "A1LL20I20ED199";
                        $campaign_key = "A1LL20I20ED199dig4ita44lmedi44a";

                        $url_api = "https://pro.allieddigitalmedia.com/api/rest/ping/add_lead";
                        ...
                        switch ($lead_type_service_id) {
                            case 1:
                                ...
                                if (strpos("-" . strtolower($campaign_name), 'affiliate') == true) {
                                    $vendor_id = "1681465033";
                                } else {
                                    $vendor_id = "1681464910";
                                }
                            ...
                            case 2:
                                ...
                                if (strpos("-" . strtolower($campaign_name), 'affiliate') == true) {
                                    $vendor_id = "1681465167";
                                } else {
                                    $vendor_id = "1681465117";
                                }
                            ...
                            case 3:
                                ...
                                if (strpos("-" . strtolower($campaign_name), 'affiliate') == true) {
                                    $vendor_id = "1681465412";
                                } else {
                                    $vendor_id = "1681465396";
                                }
                            ...
                            case 4:
                                ...
                                if (strpos("-" . strtolower($campaign_name), 'affiliate') == true) {
                                    $vendor_id = "1681465436";
                                } else {
                                    $vendor_id = "1681465427";
                                }
                            ...
                            case 5:
                                ...
                                $ownership = trim($Leaddatadetails['homeOwn']);
                                $reason = trim($Leaddatadetails['reason']);
                                $features = trim($Leaddatadetails['features']);

                                if (strpos("-" . strtolower($campaign_name), 'affiliate') == true) {
                                    $vendor_id = "1681465466";
                                } else {
                                    $vendor_id = "1681465458";
                                }
                            ...
                            case 6:
                                ...
                                if (strpos("-" . strtolower($campaign_name), 'affiliate') == true) {
                                    $vendor_id = "1681465493";
                                } else {
                                    $vendor_id = "1681465480";
                                }
                            ...
                            case 7:
                                ...
                                if (strpos("-" . strtolower($campaign_name), 'affiliate') == true) {
                                    $vendor_id = "1681465523";
                                } else {
                                    $vendor_id = "1681465511";
                                }
                            ...
                            case 8:
                                ...
                                if (strpos("-" . strtolower($campaign_name), 'affiliate') == true) {
                                    $vendor_id = "1681465552";
                                } else {
                                    $vendor_id = "1681465544";
                                }
                            ...
                            case 9:
                                ...
                                if (strpos("-" . strtolower($campaign_name), 'affiliate') == true) {
                                    $vendor_id = "1681465585";
                                } else {
                                    $vendor_id = "1681465568";
                                }
                            ...
                            case 11:
                                ...
                                if (strpos("-" . strtolower($campaign_name), 'affiliate') == true) {
                                    $vendor_id = "1681465697";
                                } else {
                                    $vendor_id = "1681465690";
                                }
                            ...
                            case 12:
                                ...
                                if (strpos("-" . strtolower($campaign_name), 'affiliate') == true) {
                                    $vendor_id = "1681465718";
                                } else {
                                    $vendor_id = "1681465711";
                                }
                            ...
                            case 13:
                                ...
                                if (strpos("-" . strtolower($campaign_name), 'affiliate') == true) {
                                    $vendor_id = "1681465745";
                                } else {
                                    $vendor_id = "1681465735";
                                }
                            ...
                            case 16:
                                ...
                                if (strpos("-" . strtolower($campaign_name), 'affiliate') == true) {
                                    $vendor_id = "1681465875";
                                } else {
                                    $vendor_id = "1681465865";
                                }
                            ...
                            case 19:
                                //Countertops
                                $countertops_service = trim($Leaddatadetails['service']);
                                $project_nature = trim($Leaddatadetails['project_nature']);
                                $start_time = trim($Leaddatadetails['start_time']);
                                $ownership = trim($Leaddatadetails['homeOwn']);

                                if (strpos("-" . strtolower($campaign_name), 'affiliate') == true) {
                                    $vendor_id = "1681465915";
                                } else {
                                    $vendor_id = "1681465909";
                                }
                            ...
                            case 21:
                                ...
                                if (strpos("-" . strtolower($campaign_name), 'affiliate') == true) {
                                    $vendor_id = "1681465954";
                                } else {
                                    $vendor_id = "1681465948";
                                }
                        ...
                        if ($is_multi_api == 0) {
                            $result = $crm_api_file->api_send_data($url_api, $httpheader, $leadCustomer_id, json_encode($Lead_data), "POST", $returns_data, $campaign_id);
                            $result2 = json_decode($result, true);
