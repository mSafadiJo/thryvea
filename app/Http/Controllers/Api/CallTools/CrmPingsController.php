...
class CrmPingsController extends Controller
{
    public function lead_from_call_tools(Request $request)
    {
        ...
        $TransactionId = (!empty($request['TransactionId']) ? $request['TransactionId'] : "");
        ...
        $data_msg['name'] = $campaign->username;;
        $data_msg['LeadService'] = $campaign->service_campaign_name;;

        $data_api_ping = new ApiPingCrm();
        $data_response = $data_api_ping->callToolsPings($campaign, $data_msg);
