      ...
      $('<a/>', attributes).on('click.stepy', function(e) {
        ...
        if (!self.opt.next || methods._execute.call(that, self.opt.next, index + 1)) {
            ...
            if($("#default-wizard-head-0").hasClass('stepy-active')) {
                if (firstname == '' || lastname == '' || email == '' || !email.match(re) || firstname.length < 3 || lastname.length < 3
                    || password == '' || password_confirmation == '' || password != password_confirmation) {
                    $("#firstname").css("border", "1px solid #dadada");
                    $("#firstname").css("box-shadow", "none");
                    $("#lastname").css("border", "1px solid #dadada");
                    ...
                    $("#password_confirmation").css("border", "1px solid #dadada");
                    $("#password_confirmation").css("box-shadow", "none");
                    if (firstname == '' || firstname.length < 3) {
                        $("#firstname").css("border", "1px solid red");
                        $("#firstname").css("box-shadow", "0 0 5px 0 red");
                    }
                    if (lastname == '' || lastname.length < 3) {
                        $("#lastname").css("border", "1px solid red");
                        $("#lastname").css("box-shadow", "0 0 5px 0 red");
                    }
                    if (email == '' || !email.match(re)) {
                        $("#email").css("border", "1px solid red");
                        $("#email").css("box-shadow", "0 0 5px 0 red");
                    }
                    if (password == '') {
                        $("#password").css("border", "1px solid red");
                        $("#password").css("box-shadow", "0 0 5px 0 red");
                    }
                    if (password_confirmation == '' || password != password_confirmation) {
                        $("#password_confirmation").css("border", "1px solid red");
                        $("#password_confirmation").css("box-shadow", "0 0 5px 0 red");
                    }
                    $('#submitForm').click();
                } else {
                    $("#firstname").css("border", "1px solid #dadada");
                ...
                if (owner == '' || businessname == '' || phonenumber == '' || mobilenumber == '' ) {
                    $("#owner").css("border", "1px solid #dadada");
                    $("#owner").css("box-shadow", "none");
                    $("#businessname").css("border", "1px solid #dadada");
                    $("#businessname").css("box-shadow", "none");
                    $("#phonenumber").css("border", "1px solid #dadada");
                    $("#phonenumber").css("box-shadow", "none");
                    $("#mobilenumber").css("border", "1px solid #dadada");
                    $("#mobilenumber").css("box-shadow", "none");
                    if (owner == '') {
                        $("#owner").css("border", "1px solid red");
                        $("#owner").css("box-shadow", "0 0 5px 0 red");
                    }
                    if (businessname == '') {
                        $("#businessname").css("border", "1px solid red");
                        $("#businessname").css("box-shadow", "0 0 5px 0 red");
                    }
                    if (phonenumber == '') {
                        $("#phonenumber").css("border", "1px solid red");
                        $("#phonenumber").css("box-shadow", "0 0 5px 0 red");
                    }
                    if (mobilenumber == '') {
                        $("#mobilenumber").css("border", "1px solid red");
                        $("#mobilenumber").css("box-shadow", "0 0 5px 0 red");
                    }
                    $('#submitForm').click();
                } else {
                    $("#owner").css("border", "1px solid #dadada");
            ...
            $(".stepy-finish").click(function(){
                ...
                if (stateList == '' || cityList == '' || zipcodeList == '' || streetname == '') {
                    // $("#stateList").css("border", "1px solid #dadada");
                    // $("#stateList").css("box-shadow", "none");
                    // $("#cityList").css("border", "1px solid #dadada");
                    // $("#cityList").css("box-shadow", "none");
                    // $("#zipcodeList").css("border", "1px solid #dadada");
                    // $("#zipcodeList").css("box-shadow", "none");
                    // $("#streetname").css("border", "1px solid #dadada");
                    // $("#streetname").css("box-shadow", "none");

                    if (stateList == '' || stateList == null) {
                        $("#stateList").css("border", "1px solid red");
                        $("#stateList").css("box-shadow", "0 0 5px 0 red");
                    }
                    if (cityList == '') {
                        $("#cityList").css("border", "1px solid red");
                        $("#cityList").css("box-shadow", "0 0 5px 0 red");
                    }
                    if (zipcodeList == '') {
                        $("#zipcodeList").css("border", "1px solid red");
                        $("#zipcodeList").css("box-shadow", "0 0 5px 0 red");
                    }
                    if (streetname == '') {
                        $("#streetname").css("border", "1px solid red");
                        $("#streetname").css("box-shadow", "0 0 5px 0 red");
                    }
                    $("#streetname").css("border", "1px solid red");
                    $("#streetname").css("box-shadow", "0 0 5px 0 red");
                    $('#submitForm').click();
