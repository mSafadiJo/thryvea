                                ...
                                @if( !empty($payments) )
                                    @foreach($payments as $payment)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="Buyers_Payment/Edit/{{ $payment->payment_id }}  " class="on-default edit-row" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" data-trigger="hover" data-animation="false">
                                                    <i class="fa fa-pencil"></i>
                                                </a>
                                                <form style="display: inline-block" action="{{ route('PaymentDelete') }}" method="post" id="DeletePaymentnForm-{{ $payment->payment_id }}">
                                                    {{ csrf_field() }}
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="addedSectionLogo pull-right"
                            onclick='window.location.href ="/Buyers_Payment/Add";'>
