...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card-box">
                <form class="form-horizontal row" id="paymantform" role="form" method="post" action="{{ route('updatePayment') }}">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group inline-block col-3 ">
                        ...
                        <div class="col-md-12">
                            <input type="text" maxlength="3" class="form-control cvv" placeholder="000" name="cvv" value="{{ $payment->payment_cvv }}" required>
                        </div>
                    </div>
