    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card-box page-title-box">
                <h4 class="header-title">Add Campaign Pay Per Rev-Share</h4>
            </div>
        </div>
    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select id="homeowned" name="homeowned[]" class="select2 form-control select2-multiple" multiple="multiple" data-placeholder="Choose ...">
