    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card-box page-title-box">
                <h4 class="header-title">Sellers Campaigns</h4>
            </div>
        </div>
    </div>
                                ...
                                @if( !empty($users) )
                                    @foreach( $users as $key => $val )
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route("Admin.Seller.Campaigns.list", $val->id) }}" class="on-default edit-row" data-toggle="tooltip" data-placement="top" title="" data-original-title="List Of Campaign" data-trigger="hover" data-animation="false">
