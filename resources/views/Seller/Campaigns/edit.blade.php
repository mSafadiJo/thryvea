                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" id="special_source" name="special_source" placeholder="src" style="min-height: 50px;">
                                                            @if($campaign->special_source)
                                                                {{ implode(",", json_decode($campaign->special_source, true)) }}
                                                            @endif
                                                        </textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" id="special_source" name="special_source_tier2" placeholder="src" style="min-height: 50px;">
                                                            {{ $campaign->special_source_tier2 ? implode(",", json_decode($campaign->special_source_tier2, true)) : '' }}
                                                        </textarea>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <br>
                                                        <span>for example: source1,source2,source3</span>
                                                        <textarea class="form-control" id="special_source" name="special_source_tier3" placeholder="src" style="min-height: 50px;">
                                                                {{ $campaign->special_source_tier3 ? implode(",", json_decode($campaign->special_source_tier3, true)) : '' }}
                                                        </textarea>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <br>
                                                        <span>for example: source1,source2,source3</span>
                                                        <textarea class="form-control" id="special_source" name="special_source_tier4" placeholder="src" style="min-height: 50px;">
                                                             {{ $campaign->special_source_tier4 ? implode(",", json_decode($campaign->special_source_tier4, true)) : '' }}
                                                        </textarea>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
