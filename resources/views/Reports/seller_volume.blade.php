    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card-box">
                ...
                <div class="row">
                    <div class="col-lg-12 text-right">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input id="sellers-reports" style="width:100%;" placeholder="type a sellers, scroll for more results" name="seller_id[]" />
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                        ...
                        <div class="row m-t-10">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <button type="button" class="btn btn-primary col-lg-12" id="FilterSellerLeadVolume">Submit</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <h4 class="header-title">Sellers Lead Volume</h4>
                <div class="row">
                    <div class="col-lg-12">
