        ...
        <div class="col-lg-12">
            <div class="card-box">
                ...
                <div>
                        ...
                        <div class="col-lg-12 text-right">
                            ...
                            <div class="reports_search_sections text-left">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label for="buyer_id">Buyers Name</label>
                                            <input id="buyers-reports" style="width:100%;" placeholder="type a buyers, scroll for more results" name="buyer_id[]" />
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="form-group">
                            ...
                            <div class="row m-t-10">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <button type="button" class="btn btn-primary col-lg-12" id="FilterLeadReport">Submit</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <h4 class="header-title">Lead Report</h4>
                    <div class="row">
                        <div class="col-lg-12">
