    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card-box page-title-box">
                <h4 class="header-title">Agents Report</h4>
            </div>
        </div>
    </div>
    @php
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <button type="button" class="btn btn-primary col-lg-12" id="FilterAgentsReport">Submit</button>
                                </div>
                            </div>
                        </div>
                    </div>
