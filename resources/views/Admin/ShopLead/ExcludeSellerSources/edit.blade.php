    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card-box page-title-box">
                <h4 class="header-title">Update Exclude Seller Sources</h4>
            </div>
        </div>
    </div>
    <form id="ShopLeadFormUpdateEx" method="POST" action="{{ route('ExcludeSellerSourcesUpdate') }}">
        {{ csrf_field() }}
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <input type="hidden" name="BuyerId" value="{{$campaign_Data->user_id}}">
                    <label for="BuyerID">Seller</label>
            ...
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control rounded-0" name="SourcesList" id="SourcesList" required rows="1">
                        {{implode(",", json_decode($campaign_Data->exclude_sources))}}
                    </textarea>
                </div>
            </div>
        </div>
