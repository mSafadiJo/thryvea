...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card-box page-title-box">
                <h4 class="header-title">Customer Lead Details</h4>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <form id="" action="{{ route('UpdateCustomerLead') }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="card-box">
                    <div class="row">
                        <div class="col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="hidden" class="form-control" id="lead_id" name="lead_id" value="{{ $leadCustomer->lead_id }}" >
                                <label for="fname">First Name</label>
                                <input type="text" class="form-control" id="fname" name="fname" value="{{ $leadCustomer->lead_fname }}" >
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="lname">Last Name</label>
                                <input type="text" class="form-control" id="lname" name="lname" value="{{ $leadCustomer->lead_lname }}" >
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="email" name="email" value="{{ $leadCustomer->lead_email }}" >
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="phone">Phone Number</label>
                                <input type="text" class="form-control" id="phone" name="phone" value="{{ $leadCustomer->lead_phone_number }}" >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select class="select2 form-control select2-hidden-accessibled" id="stateListLeadReview" name="state" required="" data-placeholder="Choose ..." tabindex="-1" aria-hidden="true">
                                    <optgroup label="States">
                                        ...
                                        <?php
                                            if( $state->state_id === $leadCustomer->state_id )   {
                                                echo "selected";
                                            }
                                            ?>
                        ...
                        <?php
                        $city_arr = explode('=>', $leadCustomer->city_name);
                        $county_arr = explode('=>', $leadCustomer->county_name);
                        ?>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <input type="hidden" class="form-control" id="countyID" value="{{ $leadCustomer->county_id }}">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <input type="hidden" class="form-control" id="CityID" value="{{ $leadCustomer->city_id }}">
                    ...
                    <div class="row">
                        <div class="col-sm-8">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="Street" id="Street" value="{{ $leadCustomer->lead_address }}" >
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <input type="hidden" class="form-control" id="zipcodeID" value="{{$leadCustomer->zip_code_list }}">
                            ...
                            {{--<input type="text" class="form-control" id="ZipCode" value="{{ $leadCustomer->zip_code_list }}" readonly>--}}
                            {{--</div>--}}
                        </div>
                    </div>
                    ...
                    @if( $leadCustomer->lead_type_service_id == 1 )
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="nutureofpro">Type of the project?</label>
                                    {{--<input type="text" class="form-control" id="nutureofpro" value="{{ $leadCustomer->installing_type_campaign }}" readonly>--}}
                                        ...
                                        <optgroup label="What is the nature of your project?">
                                            @if( !empty($campain_inistallings) )
                                                @foreach($campain_inistallings as $item)
                                                    @if( $item->installing_type_campaign == $leadCustomer->installing_type_campaign )
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    {{--<input type="text" class="form-control" id="Priority" value="{{ $leadCustomer->lead_priority_name }}" readonly>--}}
                                        ...
                                        <optgroup label="Time to start project?">
                                            @if( !empty($lead_prioritys) )
                                                @foreach($lead_prioritys as $item)
                                                    @if( $item->lead_priority_name == $leadCustomer->lead_priority_name )
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    {{--<input type="text" class="form-control" id="Ownership" value="@if( $leadCustomer->lead_ownership == 1 ) Yes @else No @endif " readonly>--}}
                                    <select class="select2 form-control" name="ownership" id="ownership" data-placeholder="Choose ...">
                                        <optgroup label="Do you own your home?">
                                            <option value="1" @if($leadCustomer->lead_ownership == 1) selected @endif>Yes</option>
                                            <option value="0" @if($leadCustomer->lead_ownership == 0) selected @endif>No</option>
                                            <option value="3" @if($leadCustomer->lead_ownership == 3) selected @endif>No, But Authorized to Make Changes</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                                        ...
                                        <optgroup label="Number of windows">
                                            ...
                                            @if( !empty($numberOfWindows) )
                                                @foreach($numberOfWindows as $item)
                                                    @if( $item->number_of_windows_c_type == $leadCustomer->number_of_windows_c_type )
                    ...
                    @elseif( $leadCustomer->lead_type_service_id == 2 )
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="numberOfitem">Type of the project?</label>
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->lead_solor_solution_list_name }}" readonly>--}}
                                        ...
                                        <optgroup label="What kind of solar power solution are you looking for?">
                                            @if( !empty($listOfsolor_solution) )
                                                @foreach($listOfsolor_solution as $item)
                                                    @if( $item->lead_solor_solution_list_name == $leadCustomer->lead_solor_solution_list_name )
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->lead_solor_sun_expouser_list_name }}" readonly>--}}
                                        ...
                                        <optgroup label="How much sun exposure does your property get?">
                                            @if( !empty($listOfsun_expouser) )
                                                @foreach($listOfsun_expouser as $item)
                                                    @if( $item->lead_solor_sun_expouser_list_name == $leadCustomer->lead_solor_sun_expouser_list_name )
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->lead_current_utility_provider_id }}" readonly>--}}
                                    <select class="select2 form-control" name="utility_provider" id="utility_provider" data-placeholder="Choose ...">
                                            ...
                                            @if(!empty($listOfutility_provider))
                                                @foreach($listOfutility_provider as $item)
                                                    <option class="utility_provider_stateId{{ $item->state_id }}" value="{{ $item->lead_current_utility_provider_name }}"
                                                            @if( $item->lead_current_utility_provider_name == $leadCustomer->lead_current_utility_provider_id ) selected @endif
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->lead_avg_money_electicity_list_name }}" readonly>--}}
                                        ...
                                        <optgroup label="What is your average monthly electricity bill?">
                                            @if( !empty($listOfAVGMoney) )
                                                @foreach($listOfAVGMoney as $item)
                                                    @if( $item->lead_avg_money_electicity_list_name == $leadCustomer->lead_avg_money_electicity_list_name )
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->property_type_campaign }}" readonly>--}}
                                        ...
                                        <optgroup label="Property Type">
                                            @if( !empty($listOfproperty) )
                                                @foreach($listOfproperty as $item)
                                                    @if( $item->property_type_campaign == $leadCustomer->property_type_campaign )
                    ...
                    @elseif( $leadCustomer->lead_type_service_id == 3 )
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="numberOfitem">Installation Preferences:</label>
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->lead_installation_preferences_name }}" readonly>--}}
                                        ...
                                        <optgroup label="Installation Preferences">
                                            @if( !empty($listOfinstallation_preferences) )
                                                @foreach($listOfinstallation_preferences as $item)
                                                    @if( $item->lead_installation_preferences_name == $leadCustomer->lead_installation_preferences_name )
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="@if( $leadCustomer->lead_have_item_before_it == 1 ) Yes @else No @endif" readonly>--}}
                                    <select class="select2 form-control" name="lead_have_item_before_it" id="lead_have_item_before_it" data-placeholder="Choose ...">
                                        <optgroup label="Do You Have An Existing Alarm And/ Or Monitoring System?">
                                            <option value="1" @if($leadCustomer->lead_have_item_before_it == 1) selected @endif>Yes</option>
                                            <option value="0" @if($leadCustomer->lead_have_item_before_it == 0) selected @endif>No</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->lead_priority_name }}" readonly>--}}
                                    <select class="select2 form-control" name="priority" id="priority" data-placeholder="Choose ...">
                                        <optgroup label="Time to start project?">
                                            @if( !empty($lead_prioritys) )
                                                @foreach($lead_prioritys as $item)
                    ...
                    @elseif( $leadCustomer->lead_type_service_id == 4 )
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="numberOfitem">Type of flooring</label>
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->lead_type_of_flooring_name }}" readonly>--}}
                                        ...
                                        <optgroup label="What type of flooring are you interested in?">
                                            @if( !empty($listOflead_type_of_flooring) )
                                                @foreach($listOflead_type_of_flooring as $item)
                                                    @if( $item->lead_type_of_flooring_name == $leadCustomer->lead_type_of_flooring_name )
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="numberOfitem">Type of the project</label>
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->lead_nature_flooring_project_name }}" readonly>--}}
                                        ...
                                        <optgroup label="What is the nature of your flooring project?">
                                            @if( !empty($listOflead_nature_flooring_project) )
                                                @foreach($listOflead_nature_flooring_project as $item)
                                                    @if( $item->lead_nature_flooring_project_name == $leadCustomer->lead_nature_flooring_project_name )
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="@if( $leadCustomer->lead_ownership == 1 ) Yes @elseif( $leadCustomer->lead_ownership == 0 ) No @else No, But Authorized to Make Changes @endif " readonly>--}}
                                    <select class="select2 form-control" name="ownership" id="ownership" data-placeholder="Choose ...">
                                        <optgroup label="Do you own your home?">
                                            <option value="1" @if($leadCustomer->lead_ownership == 1) selected @endif>Yes</option>
                                            <option value="0" @if($leadCustomer->lead_ownership == 0) selected @endif>No</option>
                    ...
                    @elseif( $leadCustomer->lead_type_service_id == 5 )
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="numberOfitem">Type of Walk-In Tub?</label>
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->lead_walk_in_tub_name }}" readonly>--}}
                                        ...
                                        <optgroup label="Why Do You Want A Walk-In Tub?">
                                            @if( !empty($listOflead_walk_in_tub) )
                                                @foreach($listOflead_walk_in_tub as $item)
                                                    @if( $item->lead_walk_in_tub_name == $leadCustomer->lead_walk_in_tub_name )
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control select2-multiple" multiple name="desired_featuers[]" id="desired_featuers" data-placeholder="Choose ...">
                                        <optgroup label="What Are The Desired Features?">
                                            <?php  $lead_desired_featuers_id_array = json_decode($leadCustomer->lead_desired_featuers_id, true);?>
                    ...
                    @elseif( $leadCustomer->lead_type_service_id == 6 )
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="numberOfitem">Type of roofing?</label>
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->lead_type_of_roofing_name }}" readonly>--}}
                                        ...
                                        <optgroup label="What type of roofing are you interested in?">
                                            @if( !empty($listOflead_type_of_roofings) )
                                                @foreach($listOflead_type_of_roofings as $item)
                                                    @if( $item->lead_type_of_roofing_name == $leadCustomer->lead_type_of_roofing_name )
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="numberOfitem">Type of the project?</label>
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->lead_nature_of_roofing_name }}" readonly>--}}
                                        ...
                                        <optgroup label="What is the nature of your roofing project?">
                                            @if( !empty($listOflead_nature_of_roofings) )
                                                @foreach($listOflead_nature_of_roofings as $item)
                                                    @if( $item->lead_nature_of_roofing_name == $leadCustomer->lead_nature_of_roofing_name )
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="numberOfitem">Property Type</label>
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->lead_property_type_roofing_name }}" readonly>--}}
                                        ...
                                        <optgroup label="What is the property type?">
                                            @if( !empty($listOflead_property_type_roofings) )
                                                @foreach($listOflead_property_type_roofings as $item)
                                                    @if( $item->lead_property_type_roofing_name == $leadCustomer->lead_property_type_roofing_name )
                    ...
                    @elseif( $leadCustomer->lead_type_service_id == 7 )
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="numberOfitem">Type of siding?</label>
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->type_of_siding_lead_type }}" readonly>--}}
                                        ...
                                        <optgroup label="What type of siding are you interested in?">
                                            @if( !empty($type_of_siding_leads) )
                                                @foreach($type_of_siding_leads as $item)
                                                    @if( $item->type_of_siding_lead_type == $leadCustomer->type_of_siding_lead_type  )
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="numberOfitem">Type of the project?</label>
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->nature_of_siding_lead_type }}" readonly>--}}
                                        ...
                                        <optgroup label="What is the nature of your siding project?">
                                            @if( !empty($nature_of_siding_leads) )
                                                @foreach($nature_of_siding_leads as $item)
                                                    @if( $item->nature_of_siding_lead_type == $leadCustomer->nature_of_siding_lead_type )
                    ...
                    @elseif( $leadCustomer->lead_type_service_id == 8 )
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="numberOfitem">Services required? </label>
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->service_kitchen_lead_type }}" readonly>--}}
                                        ...
                                        <optgroup label="What service are you interested in?">
                                            @if( !empty($service_kitchen_leads) )
                                                @foreach($service_kitchen_leads as $item)
                                                    @if( $item->service_kitchen_lead_type == $leadCustomer->service_kitchen_lead_type )
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="@if( $leadCustomer->campaign_kitchen_r_a_walls_status == 1 ) Yes @else No @endif" readonly>--}}
                                    <select class="select2 form-control" name="removing_adding_walls" id="removing_adding_walls" data-placeholder="Choose ...">
                                        <optgroup label="Does your kitchen remodel require removing or adding any walls?">
                                            <option value="1" @if($leadCustomer->campaign_kitchen_r_a_walls_status == 1) selected @endif>Yes</option>
                                            <option value="0" @if($leadCustomer->campaign_kitchen_r_a_walls_status == 0) selected @endif>No</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                    ...
                    @elseif( $leadCustomer->lead_type_service_id == 9 )
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="numberOfitem">Services required?</label>
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->campaign_bathroomtype_type }}" readonly>--}}
                                        ...
                                        <optgroup label="What type of Bathroom project are you interested in?">
                                            @if( !empty($campaign_bathroomtypes) )
                                                @foreach($campaign_bathroomtypes as $item)
                                                    @if( $item->campaign_bathroomtype_type == $leadCustomer->campaign_bathroomtype_type )
                    ...
                    @elseif( $leadCustomer->lead_type_service_id == 10 )
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="numberOfitem">Type of stairs? </label>
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->stairs_type_lead_type }}" readonly>--}}
                                        ...
                                        <optgroup label="What type of stairs?">
                                            @if( !empty($stairs_type_leads) )
                                                @foreach($stairs_type_leads as $item)
                                                    @if( $item->stairs_type_lead_type == $leadCustomer->stairs_type_lead_type )
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->stairs_reason_lead_type }}" readonly>--}}
                                        ...
                                        <optgroup label="What is the reason that you are looking for stair lift?">
                                            @if( !empty($stairs_reason_leads) )
                                                @foreach($stairs_reason_leads as $item)
                                                    @if( $item->stairs_reason_lead_type == $leadCustomer->stairs_reason_lead_type )
                    ...
                    @elseif( $leadCustomer->lead_type_service_id == 11 )
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="numberOfitem">Owner of the Property?</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->furnance_type_lead_type }}" readonly>--}}
                                        ...
                                        <optgroup label="What type of central heating system do you want?">
                                            @if( !empty($furnance_type_leads) )
                                                @foreach($furnance_type_leads as $item)
                                                    @if( $item->furnance_type_lead_type == $leadCustomer->furnance_type_lead_type )
                    ...
                    @elseif( $leadCustomer->lead_type_service_id == 12 )
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="numberOfitem">Owner of the Property?</label>
                    ...
                    @elseif( $leadCustomer->lead_type_service_id == 13 )
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="numberOfitem">Owner of the Property?</label>
                    ...
                    @elseif( $leadCustomer->lead_type_service_id == 14 )
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="numberOfitem">Owner of the Property?</label>
                    ...
                    @elseif( $leadCustomer->lead_type_service_id == 15 )
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="numberOfitem">Owner of the Property?</label>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    {{--<input type="text" class="form-control" id="nutureofpro" value="{{ $leadCustomer->plumbing_service_list_type }}" readonly>--}}
                                        ...
                                        <optgroup label="What kind of service do you need?">
                                            @if( !empty($plumbing_service_lists) )
                                                @foreach($plumbing_service_lists as $item)
                                                    @if( $item->plumbing_service_list_type == $leadCustomer->plumbing_service_list_type )
                    ...
                    @elseif( $leadCustomer->lead_type_service_id == 16 )
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="numberOfitem">Owner of the Property?</label>
                    ...
                    @elseif( $leadCustomer->lead_type_service_id == 17 )
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->sunroom_service_lead_type }}" readonly>--}}
                                        ...
                                        <optgroup label="What best describes the project?">
                                            @if( !empty($sunroom_service_leads) )
                                                @foreach($sunroom_service_leads as $item)
                                                    @if( $item->sunroom_service_lead_type == $leadCustomer->sunroom_service_lead_type )
                    ...
                    @elseif( $leadCustomer->lead_type_service_id == 18 )
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="numberOfitem">Type of project?</label>
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->handyman_ammount_work_type }}" readonly>--}}
                                        ...
                                        <optgroup label="Describe the amount of work you need to have done?">
                                            @if( !empty($handyman_ammount_works) )
                                                @foreach($handyman_ammount_works as $item)
                                                    @if( $item->handyman_ammount_work_type ==$leadCustomer->handyman_ammount_work_type )
                    ...
                    @elseif( $leadCustomer->lead_type_service_id == 19 )
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="numberOfitem">Countertop material:</label>
                                    <input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->countertops_service_lead_type }}" readonly>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="numberOfitem">Type of project?</label>
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->installing_type_campaign }}" readonly>--}}
                                    <select class="select2 form-control" name="projectnature" id="projectnature" data-placeholder="Choose ...">
                                        <optgroup label="What is the nature of your project?">
                                            @if( !empty($campain_inistallings) )
                                                @foreach($campain_inistallings as $item)
                    ...
                    @elseif( $leadCustomer->lead_type_service_id == 20 )
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="numberOfitem">Interior/Exterior?</label>
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->door_typeproject_lead_type }}" readonly>--}}
                                        ...
                                        <optgroup label="What type of door project is this?">
                                            @if( !empty($door_typeproject_leads) )
                                                @foreach($door_typeproject_leads as $item)
                                                    @if( $item->door_typeproject_lead_type == $leadCustomer->door_typeproject_lead_type )
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->number_of_door_lead_type }}" readonly>--}}
                                        ...
                                        <optgroup label="How many doors are included in this project?">
                                            @if( !empty($number_of_door_leads) )
                                                @foreach($number_of_door_leads as $item)
                                                    @if( $item->number_of_door_lead_type == $leadCustomer->number_of_door_lead_type )
                    ...
                    @elseif( $leadCustomer->lead_type_service_id == 21 )
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="numberOfitem">Gutter meterial:</label>
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->gutters_meterial_lead_type }}" readonly>--}}
                                        ...
                                        <optgroup label="Select the type of Gutter material you want:">
                                            @if( !empty($gutters_meterial_leads) )
                                                @foreach($gutters_meterial_leads as $item)
                                                    @if( $item->gutters_meterial_lead_type == $leadCustomer->gutters_meterial_lead_type )
                    ...
                    @elseif( $leadCustomer->lead_type_service_id == 22 )
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="numberOfitem">Type of service</label>
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->paving_service_lead_type }}" readonly>--}}
                                        ...
                                        <optgroup label="What service are you interested in?">
                                            @if( !empty($paving_service_lead) )
                                                @foreach($paving_service_lead as $item)
                                                    @if( $item->paving_service_lead_type == $leadCustomer->paving_service_lead_type )
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->paving_asphalt_type }}" readonly>--}}
                                        ...
                                        <optgroup label="What best describes the area needing asphalt?">
                                            @if( !empty($paving_asphalt_type) )
                                                @foreach($paving_asphalt_type as $item)
                                                    @if( $item->paving_asphalt_type == $leadCustomer->paving_asphalt_type )
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->paving_loose_fill_type }}" readonly>--}}
                                        ...
                                        <optgroup label="What type of loose fill do you want?">
                                            @if( !empty($paving_loose_fill_type) )
                                                @foreach($paving_loose_fill_type as $item)
                                                    @if( $item->paving_loose_fill_type == $leadCustomer->paving_loose_fill_type )
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="numberOfitem">Type of project</label>
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->paving_best_describes_priject_type }}" readonly>--}}
                                        ...
                                        <optgroup label="What best describes this project?">
                                            @if( !empty($paving_best_describes_priject) )
                                                @foreach($paving_best_describes_priject as $item)
                                                    @if( $item->paving_best_describes_priject_type == $leadCustomer->paving_best_describes_priject_type )
                    ...
                    @elseif( $leadCustomer->lead_type_service_id == 23 )
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="numberOfitem">Type of service</label>
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->painting_service_lead_type }}" readonly>--}}
                                        ...
                                        <optgroup label="What service are you interested in?">
                                            @if( !empty($painting_service_lead) )
                                                @foreach($painting_service_lead as $item)
                                                    @if( $item->painting_service_lead_type == $leadCustomer->painting_service_lead_type )
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="numberOfitem">Type of project</label>
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->painting1_typeof_project_type }}" readonly>--}}
                                        ...
                                        <optgroup label="What type of project is this?">
                                            @if( !empty($painting1_typeof_project) )
                                                @foreach($painting1_typeof_project as $item)
                                                    @if( $item->painting1_typeof_project_type == $leadCustomer->painting1_typeof_project_type )
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->painting1_kindsof_surfaces_type }}" readonly>--}}
                                        ...
                                        <optgroup label="What kinds of surfaces need to be painted and/or stained?">
                                            @if( !empty($painting1_kindsof_surfaces) )
                                                @foreach($painting1_kindsof_surfaces as $item)
                                                    @if( $item->painting1_kindsof_surfaces_type == $leadCustomer->painting1_kindsof_surfaces_type )
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->painting2_rooms_number_type }}" readonly>--}}
                                        ...
                                        <optgroup label="How many rooms or areas need to be painted?">
                                            @if( !empty($painting2_rooms_number) )
                                                @foreach($painting2_rooms_number as $item)
                                                    @if( $item->painting2_rooms_number_type == $leadCustomer->painting2_rooms_number_type )
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->painting2_typeof_paint_type }}" readonly>--}}
                                        ...
                                        <optgroup label="What needs to be painted?">
                                            @if( !empty($painting2_typeof_paint) )
                                                @foreach($painting2_typeof_paint as $item)
                                                    @if( $item->painting2_typeof_paint_type == $leadCustomer->painting2_typeof_paint_type )
                            ...
                            <div class="col-sm-12">
                                ...
                                <select class="select2 form-control select2-multiple" multiple name="painting3_each_feature[]" id="painting3_each_feature" data-placeholder="Choose ...">
                                    <optgroup label="Check off each feature that will need to be painted/stained. (Check all that apply)">
                                        <?php $painting3_each_feature_id_array = json_decode($leadCustomer->painting3_each_feature_id, true); ?>
                            ...
                            <div class="col-sm-12">
                                ...
                                <select class="select2 form-control select-multiple" multiple name="painting4_existing_roof[]" id="painting4_existing_roof" data-placeholder="Choose ...">
                                    <optgroup label="What best describes the condition of the existing roof?">
                                        <?php $painting4_existing_roof_id_array = json_decode($leadCustomer->painting4_existing_roof_id, true); ?>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->painting5_surfaces_textured_type }}" readonly>--}}
                                        ...
                                        <optgroup label="What surfaces need to be textured?">
                                            @if( !empty($painting5_surfaces_textured) )
                                                @foreach($painting5_surfaces_textured as $item)
                                                    @if( $item->painting5_surfaces_textured_type == $leadCustomer->painting5_surfaces_textured_type )
                            ...
                            <div class="col-sm-6">
                                ...
                                <select class="select2 form-control select2-multiple" multiple name="painting5_kindof_texturing[]" id="painting5_kindof_texturing" data-placeholder="Choose ...">
                                    <optgroup label="What kind of texturing do you need?">
                                        <?php $painting5_kindof_texturing_array = json_decode($leadCustomer->painting5_kindof_texturing_id, true); ?>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="{{ $leadCustomer->painting1_stories_number_type }}" readonly>--}}
                                        ...
                                        <optgroup label="How many stories is your home?">
                                            @if( !empty($painting1_stories_number) )
                                                @foreach($painting1_stories_number as $item)
                                                    @if( $item->painting1_stories_number_type == $leadCustomer->painting1_stories_number_type )
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    {{--<input type="text" class="form-control" id="numberOfitem" value="@if( $leadCustomer->historical_structure == 1 ) Yes @else No @endif " readonly>--}}
                                    <select class="select2 form-control" name="interior_historical" id="interior_historical" data-placeholder="Choose ...">
                                        <optgroup label="Is this location a historical structure?">
                                            <option value="1" @if($leadCustomer->historical_structure == 1) selected @endif>Yes</option>
                                            <option value="2" @if($leadCustomer->historical_structure == 2) selected @endif>No</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                    ...
                    @elseif( $leadCustomer->lead_type_service_id == 24 )
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="VehicleYear">Vehicle Make Year:</label>
                                    <input type="text" class="form-control" id="VehicleYear" name="VehicleYear" value="{{ $leadCustomer->VehicleYear }}" readonly>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="VehicleMake">Vehicle Brand::</label>
                                    <input type="text" class="form-control" id="VehicleMake" name="VehicleMake" value="{{ $leadCustomer->VehicleMake }}" readonly>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="car_model">Car Model:</label>
                                    <input type="text" class="form-control" id="car_model" name="car_model" value="{{ $leadCustomer->car_model }}" readonly>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="InsuranceCarrier">Current insurance company:</label>
                                    <input type="text" class="form-control" id="InsuranceCarrier" name="InsuranceCarrier" value="{{ $leadCustomer->InsuranceCarrier }}" readonly>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" id="more_than_one_vehicle" name="more_than_one_vehicle" data-placeholder="Choose ...">
                                        <optgroup label="Do you have more than one vehicle?">
                                            <option value="Yes" @if($leadCustomer->more_than_one_vehicle == "Yes") selected @endif>Yes</option>
                                            <option value="No" @if($leadCustomer->more_than_one_vehicle == "No") selected @endif>No</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" id="driversNum" name="driversNum" data-placeholder="Choose ...">
                                        <optgroup label="Is there more than one driver in your household?">
                                            <option value="Yes" @if($leadCustomer->driversNum == "Yes") selected @endif>Yes</option>
                                            <option value="No" @if($leadCustomer->driversNum == "No") selected @endif>No</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" id="genders" name="genders" data-placeholder="Choose ...">
                                        <optgroup label="Driver's Gender:">
                                            <option value="Male" @if($leadCustomer->genders == "Male") selected @endif>Male</option>
                                            <option value="Female" @if($leadCustomer->genders == "Female") selected @endif>Female</option>
                                            <option value="Non-binary" @if($leadCustomer->genders == "Non-binary") selected @endif>Non-binary</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-married">
                                    ...
                                    <select class="select2 form-control" id="married" name="married" data-placeholder="Choose ...">
                                        <optgroup label="Marital State of the driver:">
                                            <option value="Yes" @if($leadCustomer->married == "Yes") selected @endif>Yes</option>
                                            <option value="No" @if($leadCustomer->married == "No") selected @endif>No</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" id="license" name="license" data-placeholder="Choose ...">
                                        <optgroup label="Owner of a valid driving license:">
                                            <option value="Yes" @if($leadCustomer->license == "Yes") selected @endif>Yes</option>
                                            <option value="No" @if($leadCustomer->license == "No") selected @endif>No</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" id="driver_experience" name="driver_experience" data-placeholder="Choose ...">
                                        <optgroup label="Is the driver experienced?">
                                            <option value="Yes" @if($leadCustomer->driver_experience == "Yes") selected @endif>Yes</option>
                                            <option value="No" @if($leadCustomer->driver_experience == "No") selected @endif>No</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" id="number_of_tickets" name="number_of_tickets" data-placeholder="Choose ...">
                                        <optgroup label="Number of tickets or accidents:">
                                            <option value="0" @if($leadCustomer->number_of_tickets == "0") selected @endif>0</option>
                                            <option value="1" @if($leadCustomer->number_of_tickets == "1") selected @endif>1</option>
                                            <option value="2" @if($leadCustomer->number_of_tickets == "2") selected @endif>2</option>
                                            <option value="3" @if($leadCustomer->number_of_tickets == "3") selected @endif>3</option>
                                            <option value="4" @if($leadCustomer->number_of_tickets == "4") selected @endif>4</option>
                                            <option value="5+" @if($leadCustomer->number_of_tickets == "5+") selected @endif>5+</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" id="DUI_charges" name="DUI_charges" data-placeholder="Choose ...">
                                        <optgroup label="DUI charges:">
                                            <option value="Yes" @if($leadCustomer->DUI_charges == "Yes") selected @endif>Yes</option>
                                            <option value="No" @if($leadCustomer->DUI_charges == "No") selected @endif>No</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" id="SR_22_need" name="SR_22_need" data-placeholder="Choose ...">
                                        <optgroup label="Need for SR-22:">
                                            <option value="Yes" @if($leadCustomer->SR_22_need == "Yes") selected @endif>Yes</option>
                                            <option value="No" @if($leadCustomer->SR_22_need == "No") selected @endif>No</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" id="submodel" name="submodel" data-placeholder="Choose ...">
                                        <optgroup label="Car sub model:">
                                            <option value="Micros" @if($leadCustomer->submodel == "Micros") selected @endif>Micros</option>
                                            <option value="Hatchback" @if($leadCustomer->submodel == "Hatchback") selected @endif>Hatchback</option>
                                            <option value="Fastback" @if($leadCustomer->submodel == "Fastback") selected @endif>Fastback</option>
                                            <option value="Sedan" @if($leadCustomer->submodel == "Sedan") selected @endif>Sedan</option>
                                            <option value="Crossover" @if($leadCustomer->submodel == "Crossover") selected @endif>Crossover</option>
                                            <option value="SUV" @if($leadCustomer->submodel == "SUV") selected @endif>SUV</option>
                                            <option value="MPV" @if($leadCustomer->submodel == "MPV") selected @endif>MPV</option>
                                            <option value="Convertible" @if($leadCustomer->submodel == "Convertible") selected @endif>Convertible</option>
                                            <option value="Wagon" @if($leadCustomer->submodel == "Wagon") selected @endif>Wagon</option>
                                            <option value="Luxury" @if($leadCustomer->submodel == "Luxury") selected @endif>Luxury</option>
                                            <option value="Antique" @if($leadCustomer->submodel == "Antique") selected @endif>Antique</option>
                                            <option value="Coupe" @if($leadCustomer->submodel == "Coupe") selected @endif>Coupe</option>
                                            <option value="Sports Car" @if($leadCustomer->submodel == "Sports Car") selected @endif>Sports Car</option>
                                            <option value="Supercar" @if($leadCustomer->submodel == "Supercar") selected @endif>Supercar</option>
                                            <option value="Muscle Car" @if($leadCustomer->submodel == "Muscle Car") selected @endif>Muscle Car</option>
                                            <option value="Limousine" @if($leadCustomer->submodel == "Limousine") selected @endif>Limousine</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" id="license_status" name="license_status" data-placeholder="Choose ...">
                                        <optgroup label="License status:">
                                            <option value="Active" @if($leadCustomer->license_status == "Active") selected @endif>Active</option>
                                            <option value="International" @if($leadCustomer->license_status == "International") selected @endif>International</option>
                                            <option value="Learner" @if($leadCustomer->license_status == "Learner") selected @endif>Learner</option>
                                            <option value="Probation" @if($leadCustomer->license_status == "Probation") selected @endif>Probation</option>
                                            <option value="Restricted" @if($leadCustomer->license_status == "Restricted") selected @endif>Restricted</option>
                                            <option value="Suspended" @if($leadCustomer->license_status == "Suspended") selected @endif>Suspended</option>
                                            <option value="Temporary" @if($leadCustomer->license_status == "Temporary") selected @endif>Temporary</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" id="coverage_type" name="coverage_type" data-placeholder="Choose ...">
                                        <optgroup label="Insurance coverage type:">
                                            <option value="Preferred" @if($leadCustomer->coverage_type == "Preferred") selected @endif>Preferred</option>
                                            <option value="Premium" @if($leadCustomer->coverage_type == "Premium") selected @endif>Premium</option>
                                            <option value="Standard" @if($leadCustomer->coverage_type == "Standard") selected @endif>Standard</option>
                                            <option value="State Minimum" @if($leadCustomer->coverage_type == "State Minimum") selected @endif>State Minimum</option>
                                            <option value="Interested" @if($leadCustomer->coverage_type == "Interested") selected @endif>Interested</option>
                                            <option value="Not Interested" @if($leadCustomer->coverage_type == "Not Interested") selected @endif>Not Interested</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="datepicker1" name="birthday" placeholder="birthday" value="{{ $leadCustomer->birthday }}" autocomplete="false" class="form-control"/>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="ticket_date">Last ticket date:</label>
                                    <input type="text" id="datepicker1" name="ticket_date" placeholder="ticket_date" value="{{ $leadCustomer->ticket_date }}" autocomplete="false" class="form-control"/>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="violation_date">Violation date:</label>
                                    <input type="text" id="datepicker1" name="violation_date" placeholder="violation_date" value="{{ $leadCustomer->violation_date }}" autocomplete="false" class="form-control"/>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="accident_date">Accident date:</label>
                                    <input type="text" id="datepicker1" name="accident_date" placeholder="accident_date" value="{{ $leadCustomer->accident_date }}" autocomplete="false" class="form-control"/>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="claim_date">Insurance claim date:</label>
                                    <input type="text" id="datepicker1" name="claim_date" placeholder="claim_date" value="{{ $leadCustomer->claim_date }}" autocomplete="false" class="form-control"/>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="expiration_date">Current insurance expiration date:</label>
                                    <input type="text" id="datepicker1" name="expiration_date" placeholder="expiration_date" value="{{ $leadCustomer->expiration_date }}" autocomplete="false" class="form-control"/>
                                </div>
                            </div>
                        </div>
                    @elseif( $leadCustomer->lead_type_service_id == 25 )
                        {{-- home insurance--}}
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" id="house_type" name="house_type" data-placeholder="Choose ...">
                                        <optgroup label="What kind of home Do You Live In?">
                                            <option value="Single Family Home" @if($leadCustomer->house_type == "Single Family Home") selected @endif>Single Family Home</option>
                                            <option value="Apartment" @if($leadCustomer->house_type == "Apartment") selected @endif>Apartment</option>
                                            <option value="Condo/TownHouse" @if($leadCustomer->house_type == "Condo/TownHouse") selected @endif>Condo/TownHouse</option>
                                            <option value="Duplex" @if($leadCustomer->house_type == "Duplex") selected @endif>Duplex</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="Year_Built" name="Year_Built" value="{{ $leadCustomer->Year_Built }}" >
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" id="primary_residence" name="primary_residence" data-placeholder="Choose ...">
                                        <optgroup label="Is this your primary residence?">
                                            <option value="Yes" @if($leadCustomer->primary_residence == "Yes") selected @endif>Yes</option>
                                            <option value="No" @if($leadCustomer->primary_residence == "No") selected @endif>No</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" id="new_purchase" name="new_purchase" data-placeholder="Choose ...">
                                        <optgroup label="Is this a new purchase?">
                                            <option value="Yes" @if($leadCustomer->new_purchase == "Yes") selected @endif>Yes</option>
                                            <option value="No" @if($leadCustomer->new_purchase == "No") selected @endif>No</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" id="previous_insurance_within_last30" name="previous_insurance_within_last30" data-placeholder="Choose ...">
                                        <optgroup label="Have you had insurance within the last 30 days?">
                                            <option value="Yes" @if($leadCustomer->previous_insurance_within_last30 == "Yes") selected @endif>Yes</option>
                                            <option value="No" @if($leadCustomer->previous_insurance_within_last30 == "No") selected @endif>No</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" id="previous_insurance_claims_last3yrs" name="previous_insurance_claims_last3yrs" data-placeholder="Choose ...">
                                        <optgroup label="Have you made any home insurance claims in the past 3 years?">
                                            <option value="Yes" @if($leadCustomer->previous_insurance_claims_last3yrs == "Yes") selected @endif>Yes</option>
                                            <option value="No" @if($leadCustomer->previous_insurance_claims_last3yrs == "No") selected @endif>No</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" id="credit_rating" name="credit_rating" data-placeholder="Choose ...">
                                        <optgroup label="Credit rating?">
                                            <option value="Excellent" @if($leadCustomer->credit_rating == "Excellent") selected @endif>Excellent</option>
                                            <option value="Good" @if($leadCustomer->credit_rating == "Good") selected @endif>Good</option>
                                            <option value="Poor" @if($leadCustomer->credit_rating == "Poor") selected @endif>Poor</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                    ...
                    @elseif( $leadCustomer->lead_type_service_id == 26 || $leadCustomer->lead_type_service_id == 27 )
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" id="Height" name="Height" data-placeholder="Choose ...">
                                        <optgroup label="Select Your Height?">
                                            <option value="under 5" @if($leadCustomer->Height == 'under 5') selected @endif>Under 5' 0"</option>
                                            <option value="5 0" @if($leadCustomer->Height == "5 0") selected @endif>5' 0"</option>
                                            <option value="5 1" @if($leadCustomer->Height == "5 1") selected @endif>5' 1"</option>
                                            <option value="5 2" @if($leadCustomer->Height == "5 2") selected @endif>5' 2"</option>
                                            <option value="5 3" @if($leadCustomer->Height == "5 3") selected @endif>5' 3"</option>
                                            <option value="5 4" @if($leadCustomer->Height == "5 4") selected @endif>5' 4"</option>
                                            <option value="5 5" @if($leadCustomer->Height == "5 5") selected @endif>5' 5"</option>
                                            <option value="5 6" @if($leadCustomer->Height == "5 6") selected @endif>5' 6"</option>
                                            <option value="5 7" @if($leadCustomer->Height == "5 7") selected @endif>5' 7"</option>
                                            <option value="5 8" @if($leadCustomer->Height == "5 8") selected @endif>5' 8"</option>
                                            <option value="5 9" @if($leadCustomer->Height == "5 9") selected @endif>5' 9"</option>
                                            <option value="5 10" @if($leadCustomer->Height == "5 10") selected @endif>5' 10"</option>
                                            <option value="5 11" @if($leadCustomer->Height == "5 11") selected @endif>5' 11"</option>
                                            <option value="6 0" @if($leadCustomer->Height == "6 0") selected @endif>6' 0"</option>
                                            <option value="6 1" @if($leadCustomer->Height == "6 1") selected @endif>6' 1"</option>
                                            <option value="6 2" @if($leadCustomer->Height == "6 2") selected @endif>6' 2"</option>
                                            <option value="6 3" @if($leadCustomer->Height == "6 3") selected @endif>6' 3"</option>
                                            <option value="6 4" @if($leadCustomer->Height == "6 4") selected @endif>6' 4"</option>
                                            <option value="6 5" @if($leadCustomer->Height == "6 5") selected @endif>6' 5"</option>
                                            <option value="6 6" @if($leadCustomer->Height == "6 6") selected @endif>6' 6"</option>
                                            <option value="over 6" @if($leadCustomer->Height == "over 6") selected @endif>Over 6' 6"</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="weight" name="weight" value="{{ $leadCustomer->weight }}" >
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" id="amount_coverage" name="amount_coverage" data-placeholder="Choose ...">
                                        <optgroup label="Amount of Coverage You are Considering ?">
                                            <option value="5000" @if($leadCustomer->amount_coverage == "5000") selected @endif>$5,000</option>
                                            <option value="10000" @if($leadCustomer->amount_coverage == "10000") selected @endif>$10,000</option>
                                            <option value="20000" @if($leadCustomer->amount_coverage == "20000") selected @endif>$20,000</option>
                                            <option value="30000" @if($leadCustomer->amount_coverage == "30000") selected @endif>$30,000</option>
                                            <option value="40000" @if($leadCustomer->amount_coverage == "40000") selected @endif>$40,000</option>
                                            <option value="50000" @if($leadCustomer->amount_coverage == "50000") selected @endif>$50,000</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" id="military_personnel_status" name="military_personnel_status" data-placeholder="Choose ...">
                                        <optgroup label="Are you active or retired military personnel?">
                                            <option value="Yes" @if($leadCustomer->military_personnel_status == "Yes") selected @endif>Yes</option>
                                            <option value="No" @if($leadCustomer->military_personnel_status == "No") selected @endif>No</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" id="military_status" name="military_status" data-placeholder="Choose ...">
                                        <optgroup label="Military status ?">
                                            <option value="Active" @if($leadCustomer->military_status == "Active") selected @endif>Active</option>
                                            <option value="Inactive Reserve" @if($leadCustomer->military_status == "Inactive Reserve") selected @endif>Inactive Reserve</option>
                                            <option value="Retired" @if($leadCustomer->military_status == "Retired") selected @endif>Retired</option>
                                            <option value="Reservist" @if($leadCustomer->military_status == "Reservist") selected @endif>Reservist</option>
                                            <option value="Honorably Discharged" @if($leadCustomer->military_status == "Honorably Discharged") selected @endif>Honorably Discharged</option>
                                            <option value="Separated within 120 days" @if($leadCustomer->military_status == "Separated within 120 days") selected @endif>Separated within 120 days</option>
                                            <option value="Separated over 120 days" @if($leadCustomer->military_status == "Separated over 120 days") selected @endif>Separated over 120 days</option>
                                            <option value="Not A Military Personnel" @if($leadCustomer->military_status == "Not A Military Personnel") selected @endif>Not A Military Personnel</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" id="service_branch" name="service_branch" data-placeholder="Choose ...">
                                        <optgroup label="Service branch ?">
                                            <option value="US Air Force" @if($leadCustomer->service_branch == "US Air Force") selected @endif>US Air Force</option>
                                            <option value="US Army" @if($leadCustomer->service_branch == "US Army") selected @endif>US Army</option>
                                            <option value="US Coast Guard" @if($leadCustomer->service_branch == "US Coast Guard") selected @endif>US Coast Guard</option>
                                            <option value="US Marine Corps" @if($leadCustomer->service_branch == "US Marine Corps") selected @endif>US Marine Corps</option>
                                            <option value="US Navy" @if($leadCustomer->service_branch == "US Navy") selected @endif>US Navy</option>
                                            <option value="Not A Military Personnel" @if($leadCustomer->service_branch == "Not A Military Personnel") selected @endif>Not A Military Personnel</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                    ...
                    @elseif( $leadCustomer->lead_type_service_id == 28 )
                        {{-- Business insurance--}}
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select id="CommercialCoverage" name="CommercialCoverage[]" class="select2 form-control select2-multiple" required="" multiple="multiple" data-placeholder="Choose ...">
                                        <optgroup label="What coverage does your business need?">
                                            <?php
                                            $CommercialCoverageArray = json_decode($leadCustomer->CommercialCoverage,true);
                                            ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" id="company_benefits_quote" name="company_benefits_quote" data-placeholder="Choose ...">
                                        <optgroup label="Would you also like to get quotes for your company's benefits?">
                                            <option value="Yes" @if($leadCustomer->company_benefits_quote == "Yes") selected @endif>Yes</option>
                                            <option value="No" @if($leadCustomer->company_benefits_quote == "No") selected @endif>No</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="business_start_date" name="business_start_date" value="{{ $leadCustomer->business_start_date }}" >
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="estimated_annual_payroll" name="estimated_annual_payroll" value="{{$leadCustomer->estimated_annual_payroll }}" >
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="number_of_employees" name="number_of_employees" value="{{$leadCustomer->number_of_employees}}" >
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" id="coverage_start_month" name="coverage_start_month" data-placeholder="Choose ...">
                                        <optgroup label="When would you like the coverage to begin?">
                                            <option value="January" @if($leadCustomer->coverage_start_month == "January") selected @endif>January</option>
                                            <option value="February" @if($leadCustomer->coverage_start_month == "February") selected @endif>February</option>
                                            <option value="March" @if($leadCustomer->coverage_start_month == "March") selected @endif>March</option>
                                            <option value="April" @if($leadCustomer->coverage_start_month == "April") selected @endif>April</option>
                                            <option value="May" @if($leadCustomer->coverage_start_month == "May") selected @endif>May</option>
                                            <option value="June" @if($leadCustomer->coverage_start_month == "June") selected @endif>June</option>
                                            <option value="July" @if($leadCustomer->coverage_start_month == "July") selected @endif>July</option>
                                            <option value="August" @if($leadCustomer->coverage_start_month == "August") selected @endif>August</option>
                                            <option value="September" @if($leadCustomer->coverage_start_month == "September") selected @endif>September</option>
                                            <option value="October" @if($leadCustomer->coverage_start_month == "October") selected @endif>October</option>
                                            <option value="November" @if($leadCustomer->coverage_start_month == "November") selected @endif>November</option>
                                            <option value="December" @if($leadCustomer->coverage_start_month == "December") selected @endif>December</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="business_name" name="business_name" value="{{ $leadCustomer->business_name }}" >
                                </div>
                            </div>
                        </div>
                    @elseif( $leadCustomer->lead_type_service_id == 29 || $leadCustomer->lead_type_service_id == 30 )
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" id="pregnancy" name="pregnancy" data-placeholder="Choose ...">
                                        <optgroup label="Are you or your spouse pregnant right now, or adopting a child?">
                                            <option value="Yes" @if($leadCustomer->pregnancy == "Yes") selected @endif>Yes</option>
                                            <option value="No" @if($leadCustomer->pregnancy == "No") selected @endif>No</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" id="tobacco_usage" name="tobacco_usage" data-placeholder="Choose ...">
                                        <optgroup label="Do you use tobacco?">
                                            <option value="Yes" @if($leadCustomer->tobacco_usage == "Yes") selected @endif>Yes</option>
                                            <option value="No" @if($leadCustomer->tobacco_usage == "No") selected @endif>No</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" id="health_conditions" name="health_conditions" data-placeholder="Choose ...">
                                        <optgroup label="Do you have any of these health conditions?">
                                            <option value="Yes" @if($leadCustomer->health_conditions == "Yes") selected @endif>Yes</option>
                                            <option value="No" @if($leadCustomer->health_conditions == "No") selected @endif>No</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" id="number_of_people_in_household" name="number_of_people_in_household" data-placeholder="Choose ...">
                                        <optgroup label="How many people are in your household?">
                                            <option value="1" @if($leadCustomer->number_of_people_in_household == "1") selected @endif>1</option>
                                            <option value="2" @if($leadCustomer->number_of_people_in_household == "2") selected @endif>2</option>
                                            <option value="3" @if($leadCustomer->number_of_people_in_household == "3") selected @endif>3</option>
                                            <option value="4" @if($leadCustomer->number_of_people_in_household == "4") selected @endif>4</option>
                                            <option value="5" @if($leadCustomer->number_of_people_in_household == "5") selected @endif>5</option>
                                            <option value="6 or more" @if($leadCustomer->number_of_people_in_household == "6 or more") selected @endif>6 or more</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select id="addPeople" name="addPeople[]" class="select2 form-control select2-multiple" required="" multiple="multiple" data-placeholder="Choose ...">
                                        <optgroup label="What coverage does your business need?">
                                            <?php
                                            $addPeopleArray = json_decode($leadCustomer->addPeople,true);
                                            ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" id="annual_income" name="annual_income" data-placeholder="Choose ...">
                                        <optgroup label="What's your annual household income?">
                                            <option value="$23,340 to $35,010" @if($leadCustomer->annual_income == "$23,340 to $35,010") selected @endif>$23,340 to $35,010</option>
                                            <option value="$35,011 to $46,680" @if($leadCustomer->annual_income == "$35,011 to $46,680") selected @endif>$35,011 to $46,680</option>
                                            <option value="Over $46,680" @if($leadCustomer->annual_income == "Over $46,680") selected @endif>Over $46,680</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                        </div>
                    @elseif( $leadCustomer->lead_type_service_id == 31 )
                        {{-- debt relief --}}
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="debt_amount">Debt Amount?</label>
                                    <input type="text" class="form-control" name="debt_amount" id="debt_amount" value="{{ $leadCustomer->debt_amount }}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="debt_type">Debt Type?</label>
                                    <select class="select2 form-control" multiple name="debt_type[]" id="debt_type" data-placeholder="Choose ...">
                                        <optgroup label="Debt Type?">
                                            <option value="Credit card debt" @if(in_array("Credit card debt", json_decode($leadCustomer->debt_type))) selected @endif>Credit card debt</option>
                                            <option value="Store card debt" @if(in_array("Store card debt", json_decode($leadCustomer->debt_type))) selected @endif>Store card debt</option>
                                            <option value="Mortgage" @if(in_array("Mortgage", json_decode($leadCustomer->debt_type))) selected @endif>Mortgage</option>
                                            <option value="Medical debt" @if(in_array("Medical debt", json_decode($leadCustomer->debt_type))) selected @endif>Medical debt</option>
                                            <option value="Auto loan" @if(in_array("Auto loan", json_decode($leadCustomer->debt_type))) selected @endif>Auto loan</option>
                                            <option value="Tax debt (IRS and state)" @if(in_array("Tax debt (IRS and state)", json_decode($leadCustomer->debt_type))) selected @endif>Tax debt (IRS and state)</option>
                                            <option value="Student Loan - Federal" @if(in_array("Student Loan - Federal", json_decode($leadCustomer->debt_type))) selected @endif>Student Loan - Federal</option>
                                            <option value="Student Loan - Private" @if(in_array("Student Loan - Private", json_decode($leadCustomer->debt_type))) selected @endif>Student Loan - Private</option>
                                            <option value="Personal loan/unsecured loan" @if(in_array("Personal loan/unsecured loan", json_decode($leadCustomer->debt_type))) selected @endif>Personal loan/unsecured loan</option>
                                            <option value="Business Loan" @if(in_array("Business Loan", json_decode($leadCustomer->debt_type))) selected @endif>Business Loan</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                    ...
                    <input type="hidden" class="form-control" name="service_id" id="service_id" value="{{ $leadCustomer->lead_type_service_id }}" readonly>
