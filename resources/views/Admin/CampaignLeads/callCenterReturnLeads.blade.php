    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card-box">
                ...
                <h4 class="header-title">List Of Return Leads From Call Center</h4>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                        ...
                        <div id="table_data">
                            <div class="table-responsive">
                                <table id="pagination-table" class="table table-striped table-bordered"
                                       data-action = "/LeadCallCenterReturn/fetch_data?page=">
                                    <thead>
                                    <tr>
                                        <th>Unique ID</th>
                                        <th>Lead ID</th>
                                    ...
                                    @foreach ($ListOfLeads as $campaignlead)
                                        <tr>
                                            ...
                                            <td> {{date('m/d/Y', strtotime($campaignlead->return_date))}} </td>
                                            @if (empty($permission_users) || in_array('8-10', $permission_users) )
                                                <td>
