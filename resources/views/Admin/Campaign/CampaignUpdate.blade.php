                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form  action="{{ route('AdminCampaignUpdate') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="tab-content unloader update_campaign_admin" id="myTabContent">
                                    ...
                                    <div class="row m-t-20">
                                        <div class="col-sm-12">
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select id="LeadSourceList" multiple="multiple" class="select2 form-control select2-multiple LeadSource" name="LeadSource[]" required data-placeholder="Choose ...">
                                                            <optgroup label="Lead Source">
                                                                @if( (!empty( $sourceLead )&& in_array('All Source', $sourceLead)) || empty( $sourceLead ) )
                                                                    <option value="All Source" selected>All Source</option>
                                                                @else
                                                                    <option value="All Source">All Source</option>
                                                                @endif
                                                                @foreach( $platforms as $val )
                                                                    @if(!empty( $sourceLead )&& in_array($val->name, $sourceLead))
                                                ...
                                                <div class="@if($campaign->campaign_Type == "6") col-sm-4 @else col-sm-6 @endif">
                                                    <div class="form-group">
                                                ...
                                                <div class="@if($campaign->campaign_Type == "6") col-sm-4 @else col-sm-6 @endif">
                                                    <div class="form-group">
                                                        <label for="Campaign_name">Buyer<span class="requiredFields">*</span></label>
                                                ...
                                                @if($campaign->campaign_Type == "6")
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            <label for="transfer_numbers">Transfer Number<span class="requiredFields">*</span></label>
                                                            <input type="text" class="form-control" id="transfer_numbers" name="transfer_numbers" placeholder="" value="{{ $campaign->transfer_numbers }}">
                                                        </div>
                                                    </div>
                                                @endif
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="band_width_accept_record">Do you want to record calls for this campaign leads?</label>
                                                        <select class="select2 form-control" name="band_width_accept_record" id="band_width_accept_record" required="">
                                                            <optgroup label="Do you want to record calls for this campaign leads?">
                                                                <option value="0" @if( $campaign->band_width_accept_record == 0 ) selected @endif>Default</option>
                                                                <option value="1" @if( $campaign->band_width_accept_record == 1 ) selected @endif>Yes</option>
                                                                <option value="2" @if( $campaign->band_width_accept_record == 2 ) selected @endif>No</option>
                                                            </optgroup>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="sellers_list">The sellers whom you {{ $campain_status_selected['exclude_sellers_campaigns_type'] }} want to sell leads to for this campaign</label>
                                                        <select multiple="multiple" class="select2 form-control select2-multiple" name="sellers_list[]" id="sellers_list" disabled
                                                                {{--@if( (!(!empty( $sourceLead ) && (in_array('All Source', $sourceLead)) || in_array('Affiliate', $sourceLead)  || empty( $sourceLead )))) disabled @endif--}}
                                                        >
                                                            <optgroup label="The sellers whom you don't want to sell leads to for this campaign">
                                                                <option value=""></option>
                                                                @if(!empty($sellers))
                                                                    @foreach($sellers as $val)
                                                                        @if( empty( $campain_status_selected['exclude_sellers_campaigns'] ) )
                                                                            <option value="{{ $val->id }}">{{ $val->user_business_name }}</option>
                                                                        @else
                                                                            @if( in_array( $val->id, $campain_status_selected['exclude_sellers_campaigns']) )
                                                                                <option value="{{ $val->id }}" selected>{{ $val->user_business_name }}</option>
                                                                            @else
                                                                                <option value="{{ $val->id }}">{{ $val->user_business_name }}</option>
                                                                            @endif
                                                                        @endif
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" id="budget_exclusive" name="budget_exclusive" placeholder=""
                                                               @if($campaign->campaign_budget_exclusive) value="{{ $campaign->campaign_budget_exclusive }}" @else value="0" @endif>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="budget_period_exclusive" name="budget_period_exclusive" class="form-control">
                                                            <option value="1" @if( $campaign->period_campaign_budget_id_exclusive == 1) selected @endif >Daily</option>
                                                            <option value="2" @if( $campaign->period_campaign_budget_id_exclusive == 2) selected @endif >Weekly</option>
                                                            <option value="3" @if( $campaign->period_campaign_budget_id_exclusive == 3) selected @endif >Monthly</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" id="numberOfCustomerCampaign_exclusive" name="numberOfCustomerCampaign_exclusive" placeholder=""
                                                               @if($campaign->campaign_count_lead_exclusive) value="{{ $campaign->campaign_count_lead_exclusive }}" @else value="0" @endif>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" id="budget_bid_exclusive" name="budget_bid_exclusive" placeholder=""
                                                               @if($campaign->campaign_budget_bid_exclusive) value="{{ $campaign->campaign_budget_bid_exclusive - $campaign->virtual_price }}" @else value="0" @endif>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <label class="form-group switch">
                                                                    ...
                                                                    <?php
                                                                        if($campaign->multi_service_accept !== null){
                                                                            if($campaign->multi_service_accept == 1){
                                                                                echo "checked";
                                                                            }
                                                                        }
                                                                        ?>>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <label class="form-group switch">
                                                                    ...
                                                                    <?php
                                                                        if($campaign->sec_service_accept !== null){
                                                                            if($campaign->sec_service_accept == 1){
                                                                                echo "checked";
                                                                            }
                                                                        }
                                                                        ?>>
                                                ...
                                                @if( Auth::user()->role_id == 1 )
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label for="virtual_price">Virtual Price</label>
                                                            <input type="number" class="form-control" id="virtual_price" name="virtual_price" placeholder="0" readonly
                                                                   @if($campaign->virtual_price) value="{{ $campaign->virtual_price }}" @else value="0" @endif>
                                                        </div>
                                                    </div>
                                                @endif
                                            </div>
                                            ...
                                            @if( in_array($campaign->campaign_Type, array(4,5,6,7)) )
                                                {{-- Start Script text for call Center--}}
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <script src="https://cdn.tiny.cloud/1/pgujsz3u9bcyl4hr6pddwtdgx80fpjig8bhlcuiuyi0ay3hn/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
                                                            <script>tinymce.init({selector:'textarea'});</script>
                                                            <script>tinymce.init({selector: '#script_text_text_area'});
                                                            </script>
                                                            <label for="script_text">Script Text For Call Center</label>
                                                            <textarea class="form-control" placeholder="Script Text For Call Center" name="script_text" id="script_text_text_area">
                                                            {{ $campaign->script_text }}
                                                        </textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                {{-- End Script text for call Center--}}
                                            @endif
                                        </div>
